...
class RouterEngine:
    ...
    def get_system_prompt(self, state):
        ...
        return (
                ...
                "Engage in an explorative dialogue, asking clarifying questions to gather more information. "
                "Provide evidence-based medical guidance and consider differential diagnoses."
